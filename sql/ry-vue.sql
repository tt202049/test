...
) ENGINE = InnoDB AUTO_INCREMENT = 287 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `train_city`  (
  `citytrain_id` int NOT NULL AUTO_INCREMENT COMMENT '城际列车ID',
  `group_id` int NOT NULL COMMENT '交路ID',
  `citytrain_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '城际列车号',
  ...
  PRIMARY KEY (`citytrain_id`) USING BTREE
...
CREATE TABLE `train_commond`  (
  `commond_id` int NOT NULL COMMENT '调令id',
  `commond_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '调令名称',
  `group_id` int NULL DEFAULT NULL COMMENT '调令影响交路',
  `start_time` datetime NOT NULL COMMENT '调令开始时间',
  `end_time` datetime NULL DEFAULT NULL COMMENT '调令结束时间',
  `citytrain_id` int NULL DEFAULT NULL COMMENT '调令影响高铁id',
  `normaltrain_id` int NULL DEFAULT NULL COMMENT '调令影响普速',
  `citytrain_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '调令影响高铁车次',
  `normaltrain_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '调令影响普速车次',
  `commond_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '调令具体内容',
...
CREATE TABLE `train_high`  (
  `hightrain_id` int NOT NULL AUTO_INCREMENT COMMENT '高铁ID',
  `hightrain_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '高铁车号',
  `depature_station` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '始发站',
  ...
  PRIMARY KEY (`hightrain_id`) USING BTREE
...
CREATE TABLE `train_normal`  (
  ...
  `depature_station` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '始发站',
  `is_depature` int NOT NULL COMMENT '是否始发',
  `terminal_station` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '终到站',
  `is_avaliable` int NOT NULL COMMENT '是否开行',
  `trainset_num` int NOT NULL COMMENT '图定编组数量',
  `preset_num` int NOT NULL COMMENT '现编组数量',
  `platform_no` int NULL DEFAULT NULL COMMENT '站台号',
  `deport_no` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '检票口号',
  `max_dirction` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '最大车号方向',
  `arrive_time` datetime NOT NULL COMMENT '到站时间',
  `leave_time` datetime NOT NULL COMMENT '开车时间',
  `stay_time` int NOT NULL COMMENT '停车时间',
  `is_waterup` int NOT NULL COMMENT '是否上水',
